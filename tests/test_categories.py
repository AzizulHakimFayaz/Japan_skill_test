...
class TestCategoryTestCase(TestCase):
    ...
    def test_landing_groups_by_category(self):
        ...
        self.assertContains(response, "Basic Tests")
        self.assertContains(response, "Skill Tests")
    ...
    def test_category_chip_classes_distinct(self):
        ...
        self.assertEqual(category_label(self.basic_test), "Basic")
        self.assertEqual(category_label(self.skill_test), "Skill")
