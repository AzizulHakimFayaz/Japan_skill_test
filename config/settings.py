...
# Ensure Vercel domains are always allowed when deployed on Vercel
...
if env('DATABASE_URL', default=None):
    ...
    # Disable server-side cursors if using PgBouncer (Transaction mode)
    if env.bool('DISABLE_SERVER_SIDE_CURSORS', default=False) or 'pgbouncer' in env('DATABASE_URL', default='').lower():
...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["tests", "tests.Test", "tests.Question", "tests.Attempt", "auth"],
