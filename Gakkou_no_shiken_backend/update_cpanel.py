...
def run():
    ...
    print("=" * 60)
    print("  Gakkou No Shiken - cPanel Backend Safe Update Script")
    print("=" * 60)

    # 0. Sync schema & migrations state
    print("\n[Step 0/3] Synchronizing SQLite Schema & Migrations State...")
    try:
    ...
    print("\n[Step 1/3] Running Database Migrations (Accounts & Password Recovery)...")
    try:
        proc = subprocess.run(
    ...
    print("\n[Step 2/3] Backfilling Existing User Countries via IP Geolocation...")
    try:
        proc = subprocess.run(
    ...
    print("\n[Step 3/3] Checking Country Migration Status...")
    try:
        proc = subprocess.run(
    ...
    print("\n" + "=" * 60)
    print("  cPanel Backend Update Completed Successfully!")
    print("=" * 60)
