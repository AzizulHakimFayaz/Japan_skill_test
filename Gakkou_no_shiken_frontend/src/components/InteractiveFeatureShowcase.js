        ...
        <ScrollReveal variant="up" delay={50} duration={700} className="h-full">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-rose-50 dark:bg-rose-950/80 text-japan-red dark:text-rose-300 border border-rose-200 dark:border-rose-800/80 text-[9px] sm:text-[10px] font-black uppercase tracking-wider">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-600 dark:text-slate-400 mt-0.5 sm:mt-1 leading-relaxed font-medium line-clamp-2 sm:line-clamp-none">
                1-play exam constraints with crystal clear Japanese native voice dialogs.
              </p>
            </div>
          </div>

          {/* Interactive Animated Waveform Bar Graphic */}
          <div className="bg-slate-950 rounded-xl sm:rounded-2xl p-2.5 sm:p-3.5 border border-slate-800 flex items-center justify-between gap-2 shadow-inner">
            <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
              ...
              <span className="text-[10px] sm:text-[11px] font-mono font-bold text-slate-200 truncate">Audio #3</span>
            </div>
