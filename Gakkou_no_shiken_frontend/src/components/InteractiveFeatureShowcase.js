  ...
  return (
    <div className="space-y-3 sm:space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-b from-white to-rose-50/40 rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 border border-rose-100 shadow-2xs hover:shadow-xl hover:border-rose-200 transition-all duration-300 flex flex-col justify-between space-y-2.5 sm:space-y-4 hover-lift group">
          <div className="space-y-2 sm:space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-rose-100/80 text-japan-red border border-rose-200 text-[9px] sm:text-[10px] font-black uppercase tracking-wider">
                <Volume2 className="w-2.5 h-2.5 sm:w-3 sm:h-3 animate-pulse text-japan-red" />
                <span>HD Audio</span>
              </span>
            </div>

            <div>
              <h3 className="text-xs sm:text-lg font-black text-slate-900 leading-snug">
                Prometric Audio
              </h3>
              <p className="text-[11px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 leading-relaxed font-normal line-clamp-2 sm:line-clamp-none">
        ...
        <div className="relative overflow-hidden bg-gradient-to-b from-white to-indigo-50/40 rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 border border-indigo-100 shadow-2xs hover:shadow-xl hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between space-y-2.5 sm:space-y-4 hover-lift group">
          <div className="space-y-2 sm:space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-indigo-100/80 text-indigo-700 border border-indigo-200 text-[9px] sm:text-[10px] font-black uppercase tracking-wider">
        ...
        <div className="col-span-2 lg:col-span-1 relative overflow-hidden bg-gradient-to-b from-white to-emerald-50/40 rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 border border-emerald-100 shadow-2xs hover:shadow-xl hover:border-emerald-200 transition-all duration-300 flex flex-col justify-between space-y-2.5 sm:space-y-4 hover-lift group">
          <div className="space-y-2 sm:space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-emerald-100/80 text-emerald-800 border border-emerald-200 text-[9px] sm:text-[10px] font-black uppercase tracking-wider">
                <Activity className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-emerald-600" />
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 leading-relaxed font-normal">
