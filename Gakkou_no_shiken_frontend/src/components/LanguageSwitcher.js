  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-1.5 py-1.5 px-2.5 rounded-xl font-bold text-xs transition-all border cursor-pointer ${
          isOpen
      ...
      >
        ...
        <span className="font-extrabold">{compact ? currentLang.short : currentLang.label}</span>
