      ...
      {tests.length > 0 ? (
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-6">
          {tests.map((test) => (
            <div
              key={test.id}
              className="group bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 rounded-2xl sm:rounded-3xl hover:border-japan-red/40 dark:hover:border-rose-500/50 hover:shadow-2xl hover:shadow-red-500/10 dark:hover:shadow-[0_0_25px_rgba(220,38,38,0.15)] transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-xs hover-lift hover-shine-container mobile-app-card animate-fade-in-up"
            >
