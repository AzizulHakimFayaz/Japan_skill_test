...
export default function ScheduledCountdownBadge({
  ...
  if (size === 'hero') {
    return (
      <div className="space-y-4 text-center">
        {/* Glow Halo Card */}
        <div className="relative inline-flex flex-col items-center justify-center p-6 sm:p-8 rounded-3xl bg-slate-900/90 dark:bg-slate-950/90 border border-amber-500/40 shadow-[0_0_50px_rgba(245,158,11,0.2)] backdrop-blur-2xl">
          ...
          {/* Time Segment Boxes */}
          <div className="grid grid-cols-4 gap-2.5 sm:gap-4 font-mono">
            <div className="flex flex-col items-center p-3 sm:p-4 rounded-2xl bg-white/5 border border-white/10 min-w-[62px] sm:min-w-[85px]">
              <span className="text-2xl sm:text-4xl font-black text-amber-400">
                {formatUnit(timeLeft.days)}
              </span>
              <span className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">
                Days
              </span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 sm:p-4 rounded-2xl bg-white/5 border border-white/10 min-w-[62px] sm:min-w-[85px]">
              <span className="text-2xl sm:text-4xl font-black text-rose-400 animate-pulse">
          ...
          {showDateLabel && formattedDate && (
            <div className="mt-4 inline-flex items-center gap-1.5 text-xs text-slate-400 font-semibold bg-white/5 px-3 py-1 rounded-full border border-white/10">
  ...
  return (
    <div className="w-full bg-slate-900/90 dark:bg-[#060913]/95 border border-amber-500/40 dark:border-amber-600/40 rounded-2xl p-3 sm:p-4 shadow-xl backdrop-blur-xl space-y-2.5">
      <div className="flex items-center justify-between gap-2 border-b border-white/10 pb-2">
        <div className="flex items-center gap-1.5 text-amber-400 text-xs font-black tracking-wide uppercase">
          <Hourglass className="w-3.5 h-3.5 animate-pulse" />
          <span>{t('unlocks_in')}</span>
        </div>
        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-amber-500/20 text-amber-300 text-[10px] font-extrabold border border-amber-500/30">
      ...
      <div className="grid grid-cols-4 gap-1.5 text-center font-mono">
        <div className="bg-white/5 dark:bg-white/5 rounded-xl p-1.5 sm:p-2 border border-white/5">
          <div className="text-sm sm:text-base font-black text-amber-300">
            {formatUnit(timeLeft.days)}
          </div>
          <div className="text-[8px] sm:text-[9px] font-bold text-slate-400 uppercase">Days</div>
        </div>
        ...
        <div className="bg-white/5 dark:bg-white/5 rounded-xl p-1.5 sm:p-2 border border-white/5">
          ...
          <div className="text-[8px] sm:text-[9px] font-bold text-slate-400 uppercase">Hours</div>
        </div>
        ...
        <div className="bg-white/5 dark:bg-white/5 rounded-xl p-1.5 sm:p-2 border border-white/5">
          ...
          <div className="text-[8px] sm:text-[9px] font-bold text-slate-400 uppercase">Mins</div>
        </div>

        <div className="bg-white/5 dark:bg-white/5 rounded-xl p-1.5 sm:p-2 border border-white/5">
          <div className="text-sm sm:text-base font-black text-rose-400 animate-pulse">
            {formatUnit(timeLeft.seconds)}
          </div>
          <div className="text-[8px] sm:text-[9px] font-bold text-slate-400 uppercase">Secs</div>
        </div>
      </div>

      {showDateLabel && formattedDate && (
        <div className="text-center text-[10px] text-slate-400 font-medium truncate pt-0.5">
